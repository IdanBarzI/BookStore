...
namespace BookStore.Services.Service
{
    public class FrameNavigationService : IFrameNavigationService, INotifyPropertyChanged
    {
        ...
        public static void SetupNavigation(ServiceCollection services)
        {
            FrameNavigationService navigationService = new FrameNavigationService();

            navigationService.Configure("AddProduct", new Uri(@"Views/AddProduct.xaml", UriKind.RelativeOrAbsolute));
            navigationService.Configure("ResultsDataGrid", new Uri(@"Views/ResultsDataGrid.xaml", UriKind.RelativeOrAbsolute));
